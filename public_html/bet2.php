    ...
    <div class="card-body" style="margin-top:200px;">
            ...
            <form class="form-signin" action=" " method="POST">
              <div class="form-label-group">
                <input type="text" name="bet2" class="form-control"  required autofocus>
...
$sql="UPDATE casino_tbl SET vmoney='$money',userbet='$pbet2' where userid='$str'";
...
echo "<script>
	window.location.href='itquiz.html';
	</script>";
	exit;
