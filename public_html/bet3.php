    ...
    <div class="card-body" style="margin-top:200px;">
            ...
            <form class="form-signin" action=" " method="POST">
              <div class="form-label-group">
                <input type="text" name="bet3" class="form-control"  required autofocus>
...
$sql="UPDATE casino_tbl SET vmoney='$money',userbet='$pbet3' where userid='$str'";
