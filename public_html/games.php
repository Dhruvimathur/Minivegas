...
<html lang="en">
  ...
  <div class="card-body" style="background-image:url('crossword.jpeg');">
    
    <p class="card-text"><h2 style="color:black;"><b>CROSSWORD</b></h2></p>
...
<div class="card text-center">
  ...
  <div class="card-body" style="background-image:url('number.jpeg');">
    
    <p class="card-text"><h2 style="color:white;"><b>E-TAMBOLA</b></h2></p>
    <!-- Button trigger modal -->
...
<div class="card text-center">
  ...
  <div class="card-body" style="background-image:url('spiz.jpeg');" >
    
    <p class="card-text"><h2 style="color:black;"><b>SPIZ</b></h2></p>
    <!-- Button trigger modal -->
...
<p>The scores will be as follows :</p>
                                                           ...
                                                           <p> If score >=60 then you will be Winner! </p>
                                         <p>Contact the coordinator in case of any query or confusion</p>
...
<div class="card text-center">
  ...
  <div class="card-body" style="background-image:url('apti.jpeg');">
    
    <p class="card-text"><h2 style="color:white;"><b>A FOR APTITUDE</b></h2></p>
    <!-- Button trigger modal -->
...
<p>The scores will be as follows :</p>
  ...
  <div class="card-body" style="background-image:url('jenga.jpg');">
    
    <p class="card-text"><h2 style="color:black;"><b>JENGA</b></h2></p>
    <!-- Button trigger modal -->
...
<div class="modal fade" id="exampleModal5" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p> 1. 6 players will play at a time.</p>
<p>2. Blocks to be pulled will have 3 types of questions:-</p>
             <p>  Red:  Output Question(40 points)</p>
              <p> Green: Complete the function Questions(30 points)</p>
...
<div class="card text-center">
  ...
  <div class="card-body" style="background-image:url('3patti.jpeg');">
    
    <p class="card-text"><h2 style="color:black;"><b>TEEN PATTI</b></h2></p>
    <!-- Button trigger modal -->
...
<div class="card text-center">
  ...
  <div class="card-body" style="background-image:url('?.jpeg');">
    
    <p class="card-text"><h2 style="color:black;"><b>?</b></h2></p>
    <!-- Button trigger modal -->
