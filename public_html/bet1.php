    ...
    <div class="card-body" style="margin-top:200px;">
            ...
            <form class="form-signin" action=" " method="POST">
              <div class="form-label-group">
                <input type="text" name="bet1" class="form-control"  required autofocus>
...
$sql="select vmoney from casino_tbl where userid='$str'";
	...
	if($pbet1>=50 && $pbet1<=$money)
	{
	  $money=$money-$pbet1;
	
	
	
$sql="UPDATE casino_tbl SET vmoney='$money',userbet='$pbet1' where userid='$str'";
